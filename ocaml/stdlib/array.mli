...
val init : int -> (int -> 'a) -> 'a array @@ portable
...
val make_matrix : int -> int -> 'a -> 'a array array @@ portable
...
val init_matrix : int -> int -> (int -> int -> 'a) -> 'a array array @@ portable
...
val sub : 'a array -> int -> int -> 'a array @@ portable
...
val fill : 'a array -> int -> int -> 'a -> unit @@ portable
...
val iter : ('a -> unit) -> 'a array -> unit @@ portable
(** [iter f a] applies function [f] in turn to all
   the elements of [a].  It is equivalent to
   [f a.(0); f a.(1); ...; f a.(length a - 1); ()]. *)

val iteri : (int -> 'a -> unit) -> 'a array -> unit @@ portable
(** Same as {!iter}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val map : ('a -> 'b) -> 'a array -> 'b array @@ portable
(** [map f a] applies function [f] to all the elements of [a],
   and builds an array with the results returned by [f]:
   [[| f a.(0); f a.(1); ...; f a.(length a - 1) |]]. *)

val map_inplace : ('a -> 'a) -> 'a array -> unit @@ portable
(** [map_inplace f a] applies function [f] to all elements of [a],
    and updates their values in place.
    @since 5.1 *)

val mapi : (int -> 'a -> 'b) -> 'a array -> 'b array @@ portable
(** Same as {!map}, but the
   function is applied to the index of the element as first argument,
   and the element itself as second argument. *)

val mapi_inplace : (int -> 'a -> 'a) -> 'a array -> unit @@ portable
(** Same as {!map_inplace}, but the function is applied to the index of the
    element as first argument, and the element itself as second argument.
    @since 5.1 *)

val fold_left : ('acc -> 'a -> 'acc) -> 'acc -> 'a array -> 'acc @@ portable
(** [fold_left f init a] computes
   [f (... (f (f init a.(0)) a.(1)) ...) a.(n-1)],
   where [n] is the length of the array [a]. *)

val fold_left_map :
  ('acc -> 'a -> 'acc * 'b) -> 'acc -> 'a array -> 'acc * 'b array @@ portable
(** [fold_left_map] is a combination of {!fold_left} and {!map} that threads an
    accumulator through calls to [f].
    @since 4.13 *)

val fold_right : ('a -> 'acc -> 'acc) -> 'a array -> 'acc -> 'acc @@ portable
...
val iter2 : ('a -> 'b -> unit) -> 'a array -> 'b array -> unit @@ portable
...
val map2 : ('a -> 'b -> 'c) -> 'a array -> 'b array -> 'c array @@ portable
...
val find_index : ('a -> bool) -> 'a array -> int option @@ portable
...
val find_map : ('a -> 'b option) -> 'a array -> 'b option @@ portable
(** [find_map f a] applies [f] to the elements of [a] in order, and returns the
    first result of the form [Some v], or [None] if none exist.

    @since 4.13 *)

val find_mapi : (int -> 'a -> 'b option) -> 'a array -> 'b option @@ portable
...
val sort : ('a -> 'a -> int) -> 'a array -> unit @@ portable
...
val stable_sort : ('a -> 'a -> int) -> 'a array -> unit @@ portable
...
val fast_sort : ('a -> 'a -> int) -> 'a array -> unit @@ portable
(** Same as {!sort} or {!stable_sort}, whichever is
    faster on typical input. *)

val shuffle :
  rand: (* thwart tools/sync_stdlib_docs *) (int -> int) -> 'a array -> unit @@ portable
