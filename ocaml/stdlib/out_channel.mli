...
val stdout : t @@ portable
(** The standard output for the process. *)

val stderr : t @@ portable
...
val output_char : t -> char -> unit @@ portable
(** Write the character on the given output channel. *)

val output_byte : t -> int -> unit @@ portable
...
val output_string : t -> string -> unit @@ portable
(** Write the string on the given output channel. *)

val output_bytes : t -> bytes -> unit @@ portable
(** Write the byte sequence on the given output channel. *)

(** {1:advanced_output Advanced output} *)

val output : t -> bytes -> int -> int -> unit @@ portable
...
val output_substring : t -> string -> int -> int -> unit @@ portable
...
val is_buffered : t -> bool @@ portable
